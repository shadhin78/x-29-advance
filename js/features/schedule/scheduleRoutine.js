...
// Page-specific state variables
    ...
    global.switchRoutineSet = window.switchRoutineSet;
    global.selectScheduleColor = window.selectScheduleColor;
    global.onScheduleTrackChange = window.onScheduleTrackChange;
    global.openAddScheduleModal = window.openAddScheduleModal;
    global.openEditScheduleModal = window.openEditScheduleModal;
    global.deleteScheduleBlock = window.deleteScheduleBlock;
    global.submitAddScheduleBlock = window.submitAddScheduleBlock;
    global.openAddScheduleModal2 = window.openAddScheduleModal2;
    global.openCreateScheduleGroup = window.openCreateScheduleGroup;
    global.submitCreateScheduleGroup = window.submitCreateScheduleGroup;
    global.deleteScheduleGroup = window.deleteScheduleGroup;
    global.assignSlotToGroup = window.assignSlotToGroup;
    global.removeSlotFromGroup = window.removeSlotFromGroup;
    global.getGroupForWork = window.getGroupForWork;
    global.renderSchedulePage = window.renderSchedulePage;
    global.DailySchedulePage = window.DailySchedulePage;

    if (!global.scheduleGroups) global.scheduleGroups = window.scheduleGroups || [];
    if (global.selectedScheduleColor === undefined) global.selectedScheduleColor = window.selectedScheduleColor || '#6366f1';

    if (typeof module !== 'undefined' && module.exports) {
        module.exports = {
            DailySchedulePage: global.DailySchedulePage,
            switchRoutineSet: global.switchRoutineSet,
            renderSchedulePage: global.renderSchedulePage,
            openAddScheduleModal: global.openAddScheduleModal,
            openEditScheduleModal: global.openEditScheduleModal,
            deleteScheduleBlock: global.deleteScheduleBlock,
            submitAddScheduleBlock: global.submitAddScheduleBlock,
            openCreateScheduleGroup: global.openCreateScheduleGroup,
            submitCreateScheduleGroup: global.submitCreateScheduleGroup,
            deleteScheduleGroup: global.deleteScheduleGroup,
            assignSlotToGroup: global.assignSlotToGroup,
            removeSlotFromGroup: global.removeSlotFromGroup,
            getGroupForWork: global.getGroupForWork
        };
    }
