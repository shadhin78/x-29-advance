...
// Daily Actions CRUD functions (appendNewAction, openEditDailyActionModal, saveDailyActionEditModal, requestDeleteDailyActionFromModal) extracted to js/features/habits/dailyTracker.js
...
window.navigateDay = function (mode) {
    ...
    if (mode === 'past') {
        window.currentDailyTargetsDate.setDate(window.currentDailyTargetsDate.getDate() - 1);
    } else if (mode === 'future') {
        window.currentDailyTargetsDate.setDate(window.currentDailyTargetsDate.getDate() + 1);
    } else {
        window.currentDailyTargetsDate = new Date();
